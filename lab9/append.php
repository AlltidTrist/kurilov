...
$str_sql_query= "SELECT * FROM Tbl"; // Запрос к таблице
...
// $str_sql query="INSERT INTO Tbl SET Nom='$newnom', Fam='$newfam'";
// Вставляем строку новой записи 2 вариант
// $str_sql_query="INSERT INTO Tbl(nom, fam) VALUES ('55555555','Иванов')";
...
//
$str_sql_query="DELETE FROM Tbl WHERE nom='55555555'";
